...
axes[0].set_title('a) Mass Solve (bicgstab)', fontsize=18, fontweight="normal")
...
axes[1].set_title('b) Charge Solve (bicgstab)', fontsize=18, fontweight="normal")
...
# plot comparison to pypardiso, gmres solver
...
axes[0].set_xticks(x)
axes[0].set_xticklabels(labels, fontsize=16)
axes[0].set_title('a) Mass Solve (gmres)', fontsize=18, fontweight="normal")
axes[0].legend(handles=legend_elements, frameon=True)
axes[0].grid(True, which='both', axis='y', linestyle='--', linewidth=0.4, alpha=0.6)
axes[0].set_ylabel("Time (s)", fontsize=16)
# second subplot
...
axes[1].set_xticks(x)
axes[1].set_xticklabels(labels, fontsize=16)
axes[1].set_title('b) Charge Solve (gmres)', fontsize=18, fontweight="normal")
axes[1].legend(handles=legend_elements, frameon=True)
axes[1].grid(True, which='both', axis='y', linestyle='--', linewidth=0.4, alpha=0.6)
...
axes[0].bar(x, y3, bottom=y1+y2, label="Solve (bicgstab)", color="tab:orange")
axes[0].set_xticks(x)
axes[0].set_xticklabels(labels, fontsize=16)
axes[0].grid(True, which='both', axis='y', linestyle='--', linewidth=0.4, alpha=0.6)
...
axes[1].bar(x, y3, bottom=y1+y2, label="Solve (bicgstab)", color="tab:orange")
axes[1].set_xticks(x)
axes[1].set_xticklabels(labels, fontsize=16)
...
axes[0].bar(x, y1, label="Build A and b", color="tab:blue")
axes[0].bar(x, y2, bottom=y1, label="Update Source", color="tab:green")
axes[0].bar(x, y3, bottom=y1+y2, label="Solve (gmres)", color="tab:orange")
axes[0].set_xticks(x)
axes[0].set_xticklabels(labels, fontsize=16)
axes[0].grid(True, which='both', axis='y', linestyle='--', linewidth=0.4, alpha=0.6)
axes[0].set_title('a) Mass', fontsize=18, fontweight="normal")
...
axes[1].bar(x, y1, label="Build A and b", color="tab:blue")
axes[1].bar(x, y2, bottom=y1, label="Update Source", color="tab:green")
axes[1].bar(x, y3, bottom=y1+y2, label="Solve (gmres)", color="tab:orange")
axes[1].set_xticks(x)
axes[1].set_xticklabels(labels, fontsize=16)
axes[1].set_title('b) Charge', fontsize=18, fontweight="normal")
axes[1].grid(True, which='both', axis='y', linestyle='--', linewidth=0.4, alpha=0.6)
