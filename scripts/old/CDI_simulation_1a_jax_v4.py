...
Ca = 140 * 100 ** 3  # prpts.properties["Ca"]
mu_att = 0.0  # prpts.properties["mu_att"]
P_in = 70.0  # prpts.properties["P_in"]
...
Acell = 1.55/7/100 * 1.55/7/100  # m2
f = Acell/Ax
...
for t in jnp.arange(t0+dt, tf+0.9*dt, dt):
    ...
    c_avg.append(jnp.average(c))
    phi_avg.append(jnp.average(jnp.abs(phi)))
